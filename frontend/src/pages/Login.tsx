    ...
    <div className="min-h-screen flex items-center justify-center bg-navy-950 px-4 py-12 relative overflow-hidden font-sans">
      ...
      <div className="max-w-md w-full space-y-8 bg-navy-900 border border-navy-800/80 p-8 md:p-10 rounded-2xl shadow-xl z-10">
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <p className="text-xs text-slate-400 font-medium tracking-wide uppercase mt-1">Invoice Generation System</p>
        </div>
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  {...register('email')}
                  className={`
                    w-full pl-10 pr-4 py-3 rounded-lg bg-navy-950 border text-slate-200 placeholder-slate-600 focus:outline-none focus:ring-1 focus:ring-amber-gold focus:border-amber-gold transition text-sm
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  {...register('password')}
                  className={`
                    w-full pl-10 pr-10 py-3 rounded-lg bg-navy-950 border text-slate-200 placeholder-slate-600 focus:outline-none focus:ring-1 focus:ring-amber-gold focus:border-amber-gold transition text-sm
          ...
          <button
            ...
            className="w-full py-3.5 px-4 bg-amber-gold hover:bg-amber-500 disabled:bg-amber-gold/50 text-navy-950 font-bold text-sm rounded-lg shadow-lg hover:shadow-amber-gold/5 transition-all flex items-center justify-center gap-2 group cursor-pointer"
          >
            {isSubmitting ? (
        ...
        <div className="text-center mt-6">
          <p className="text-xs text-slate-400">
            ...
            <Link to="/register" className="text-amber-gold font-bold hover:underline">
              Create an account
            </Link>
          </p>
        </div>
